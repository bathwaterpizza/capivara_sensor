...
The device's status is shown at all times in the display, along with unique buzzer beep patterns for different states, and the two LEDs. In addition, there used to be a speaker module welcoming the students with our professor's voice, but the idea was scraped after we realized how annoying it was.
...
pics here, todo add picture/video folder
